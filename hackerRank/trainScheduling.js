...
console.log("msg 5");
console.log("msg 6");
When we run this code using the JavaScript compiler, we get the following output:
...
msg 3
msg 2
Because the compiler defined in the Problem Statement above appends a  at the end of all  statements, the output will be:
