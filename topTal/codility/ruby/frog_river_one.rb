...
#
# to get to the opposite bank (position X+1). Leaves fall from a tree
...
#   covered by leaves). You may assume that the speed of the current
...
frog_river_one(5, [1, 3, 1, 4, 2, 3, 5, 4])
